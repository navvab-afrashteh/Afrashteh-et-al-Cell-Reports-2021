function R1_SponMeasRelationVC(roi)
close all
clc
...
fprintf('spon speed: m = %0.3f; pval = %0.40f; R2 = %0.2f\n',mS,pS,RsquaredS)
fprintf('evok speed: m = %0.3f; pval = %0.52f; R2 = %0.2f\n\n',mE,pE,RsquaredE)
% plotting
hold on;
scatter(ampS,spdS,'b.')
scatter(ampE,spdE,'r.')
...
plot(xS,yS,'color','b','linewidth',2)
plot(xE,yE,'color','r','linewidth',2)
yM = 1; ym = -1; xM = 2; if ss==2; xM = 1.2; end
% significancy
[~,sig] = isSignificant(pS);
xt = xM*0.5;
a = 0.2; if ss==2; a = 0.2; end
...
plot(xS,yS,'color','b','linewidth',2)
plot(xE,yE,'color','r','linewidth',2)
yM = 1.6; ym = 0.8; xM = 1.2; if ss==2; xM = 0.65; end
% significancy
[~,sig] = isSignificant(pS);
xt = xM*0.5;
a = 0.2; if ss==2; a = 0.2; end
