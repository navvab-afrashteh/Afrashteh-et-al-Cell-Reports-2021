function dists = getDistributionsSpon_simple_artur (d,anum,roi,ss,stdn,amplitude_threshold)
alldf = [];
alldfd = [];
alluv = [];
allang = [];
...
for an = anum
    listR = listOfRecordingsSpon(d.animalNumber(anum));
    jjc = 0;
    jjcd = 0;
    for ii = 1:size(d.d,2)
