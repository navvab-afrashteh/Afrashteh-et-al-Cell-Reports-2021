function Artur_figure_Speed_Distributions_2 (ss,roi)

if ~exist('ss','var')
    ss = 1; roi = 2;
end

allMaxs = [50 50 50 50;40 20 20 40;40 20 20 40];
...
% save('FL_vsdi_motifs_averaged_data.mat','valsE','valsSCC','valsS');
% load('FL_vsdi_motifs_averaged_data.mat');
...
x1 = 15; x2 = x1+2; y1 = (0.22:0.04:0.7); y1 = y1(1:4); y2 = y1;
