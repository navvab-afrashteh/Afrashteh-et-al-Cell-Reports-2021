function motifs = getMotifsFromCCResultsSam_simple_AC(animalNumber,listR,ii,thn,match,CrossOrMax,LMHname,varargin)
multLevels = 1;
if nargin > 7
...
dataType = 'AC';
[lists, names]= getEvokedListsDiffStimAmps_glut(animalNumber(1),multLevels,dataType);
if strcmp(match,'FL')
...
thmin = 0.4;
if strcmp(animalNumber{1},'2015-05-05')
    thmin = 0.3;
end
