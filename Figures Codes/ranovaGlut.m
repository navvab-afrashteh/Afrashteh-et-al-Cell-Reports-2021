function prT = ranovaGlut(annovaVar)
% run repeated measure anova on data from FL or HL stim

animals = {'animal 1','animal 2','animal 3','animal 4','animal 5'}';
subnetworks = {'SCC', 'L', 'H'};
t = table(animals,annovaVar(:,1),annovaVar(:,2),annovaVar(:,3),...
'VariableNames',{'animals','meas1','meas2','meas3'});
...
tbl([6,5,3],{'subnetworks_1','subnetworks_2','pValue'})
